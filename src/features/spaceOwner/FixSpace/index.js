...
export default function FixSpace() {
    ...
    useEffect(() => {
        ...
        setRoomList(myPlace.rooms.map((room) => ({
            name: room.name,
    ...
    const handleExitClick = () => {
        ...
        if (isEmpty) {
            ...
            const isExit = confirm('수정한 정보가 모두 사라집니다. 정말 나가시겠습니까?');
            if (isExit) {
